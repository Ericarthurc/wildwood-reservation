...
const ServiceForm = () => {
  ...
  const getServices = async () => {
    try {
      ...
      setServiceFour(res.data[3]);
      setServiceFive(res.data[4]);
      setServiceSix(res.data[5]);
  ...
  const formHandler = async e => {
    ...
    try {
      if (radioCheck && formSeats && formName && validator.isEmail(formEmail)) {
        await axios.post("/forms/services", [
          { _id: radioID, serviceSeats: formSeats },
          {
            service: radioCheck,
            seats: formSeats,
            name: formName,
      ...
      if (e.response.status === 400) {
        ...
        setStatusMessage(
          `The selected service does not have ${formSeats} seats available`
        );
            ...
            <Col>
              <div>
                ...
                <Form.Label>
                  <div
                    className={
                      serviceOne.serviceSeats <= 0
                        ? "serviceIconDisabled"
                        : radioCheck === "Monday 4:00pm"
                        ? "serviceIconClicked"
                        : "serviceIcon"
                    }
                  >
                  ...
                  <Form.Check
                    ...
                    checked={radioCheck === "Monday 4:00pm"}
              ...
              <div>
                {serviceOne.serviceSeats <= 0 ? (
                  ...
                  <p key={serviceOne._id}>Seats: {serviceOne.serviceSeats}</p>
                )}
              </div>
            </Col>
            <Col>
              <div>
                ...
                <Form.Label>
                  <div
                    className={
                      serviceTwo.serviceSeats <= 0
                        ? "serviceIconDisabled"
                        : radioCheck === "Monday 6:00pm"
                        ? "serviceIconClicked"
                        : "serviceIcon"
                    }
                  >
                  ...
                  <Form.Check
                    ...
                    checked={radioCheck === "Monday 6:00pm"}
              ...
              <div>
                {serviceTwo.serviceSeats <= 0 ? (
                  ...
                  <p key={serviceTwo._id}>Seats: {serviceTwo.serviceSeats}</p>
                )}
              </div>
            </Col>
            <Col lg={3}></Col>
            ...
            <Col>
              <div>
                ...
                <Form.Label>
                  <div
                    className={
                      serviceThree.serviceSeats <= 0
                        ? "serviceIconDisabled"
                        : radioCheck === "Tuesday 12:00pm"
                        ? "serviceIconClicked"
                        : "serviceIcon"
                    }
                  >
              ...
              <div>
                {serviceThree.serviceSeats <= 0 ? (
                  ...
                  <p key={serviceThree._id}>
                    Seats: {serviceThree.serviceSeats}
                  </p>
                )}
              </div>
            </Col>
            <Col>
              <div>
                ...
                <Form.Label>
                  <div
                    className={
                      serviceFour.serviceSeats <= 0
                        ? "serviceIconDisabled"
                        : radioCheck === "Tuesday 2:00pm"
                        ? "serviceIconClicked"
                        : "serviceIcon"
                    }
                  >
                  ...
                  <Form.Check
                    className="radioButton"
                    type="radio"
                    value="Tuesday 2:00pm"
                    key={serviceFour._id}
                    onChange={e => radioHandler(e, serviceFour._id)}
                    checked={radioCheck === "Tuesday 2:00pm"}
              ...
              <div>
                {serviceFour.serviceSeats <= 0 ? (
                  ...
                  <p key={serviceFour._id}>Seats: {serviceFour.serviceSeats}</p>
                )}
              </div>
            </Col>
            <Col>
              <div>
                ...
                <Form.Label>
                  <div
                    className={
                      serviceFive.serviceSeats <= 0
                        ? "serviceIconDisabled"
                        : radioCheck === "Tuesday 4:00pm"
                        ? "serviceIconClicked"
                        : "serviceIcon"
                    }
                  >
                  ...
                  <Form.Check
                    className="radioButton"
                    type="radio"
                    value="Tuesday 4:00pm"
                    key={serviceFive._id}
                    onChange={e => radioHandler(e, serviceFive._id)}
                    checked={radioCheck === "Tuesday 4:00pm"}
              ...
              <div>
                {serviceFive.serviceSeats <= 0 ? (
                  ...
                  <p key={serviceFive._id}>Seats: {serviceFive.serviceSeats}</p>
                )}
              </div>
            </Col>
            <Col>
              <div>
                ...
                <Form.Label>
                  <div
                    className={
                      serviceSix.serviceSeats <= 0
                        ? "serviceIconDisabled"
                        : radioCheck === "Tuesday 6:00pm"
                        ? "serviceIconClicked"
                        : "serviceIcon"
                    }
                  >
                  ...
                  <Form.Check
                    className="radioButton"
                    type="radio"
                    value="Tuesday 6:00pm"
                    key={serviceSix._id}
                    onChange={e => radioHandler(e, serviceSix._id)}
                    checked={radioCheck === "Tuesday 6:00pm"}
              ...
              <div>
                {serviceSix.serviceSeats <= 0 ? (
                  ...
                  <p key={serviceSix._id}>Seats: {serviceSix.serviceSeats}</p>
                )}
              </div>
            </Col>
            <Col lg={2}></Col>
            ...
            <Col xs={8} lg={6}>
              ...
              <Form.Group>
                <Form.Control
                  ...
                  max="10"
                  name="formSeats"
                  placeholder="How many seats 1-10:"
                ></Form.Control>
                <Form.Control
                  type="text"
                  name="formName"
